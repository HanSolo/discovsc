...
export function activate(context: vscode.ExtensionContext) {
    ...
    let disposable = vscode.commands.registerCommand('extension.discovsc', () => {
        // The code you place here will be executed every time your command is executed
        
        // Display a message box to the user
        //vscode.window.showInformationMessage('DiscoVSC');

        vscexpress.open('index.html', 'Foojay JDK Discovery Service', vscode.ViewColumn.One);
    });
